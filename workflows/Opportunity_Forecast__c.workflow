...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>Forecast Update Oppy Last Modified</fullName>
        <active>false</active>
        <description>This WF rule triggers update of custom Opportunity Last Modified Date field in case a forecast record is created or updated.</description>
