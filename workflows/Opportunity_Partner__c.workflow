...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>Partner Update Oppy Last Modified</fullName>
        <active>false</active>
        <description>This WF rule triggers update of custom Opportunity Last Modified Date field in case a partner record is created or updated.</description>
