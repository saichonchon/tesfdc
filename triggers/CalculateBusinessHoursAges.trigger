trigger CalculateBusinessHoursAges on Case (before insert, before update) {
    if (Trigger.isInsert && CaseUtil_CCP.CalculateBusinessHoursAgesInsert==false) {
        CaseUtil_CCP.CalculateBusinessHoursAgesInsert=true;
    ...
    } if(Trigger.isUpdate && CaseUtil_CCP.CalculateBusinessHoursAgesUpdate == false){
        CaseUtil_CCP.CalculateBusinessHoursAgesUpdate=true;
