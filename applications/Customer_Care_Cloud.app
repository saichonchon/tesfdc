...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <label>Customer Care Service Cloud</label>
    <preferences>
    ...
    <tabs>TE_Employee__c</tabs>
    <tabs>Customer_Support_Survey__c</tabs>
    ...
    <workspaceConfig>
        <mappings>
            <tab>Channel_NPS_Feedbacks__c</tab>
        </mappings>
        <mappings>
            <tab>ClickTools</tab>
        </mappings>
        <mappings>
            <tab>Customer_Support_Survey__c</tab>
        </mappings>
        <mappings>
